...
//         "http://localhost:3000/api/student/admission",
//         data
//       );
...
//                 className="form-control"
//                 value={schoolCity}
//                 onChange={(e) => setSchoolCityName(e.target.value)}
//               />
//             </div>
      ...
      <div className="card shadow border-0 rounded-4 p-4">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          <div className="row g-4">
            ...
            {/* ✅ Show course details automatically */}
            {selectedCourse && (
              <div className="col-md-8">
                <div className="border p-3 rounded bg-light">
                  <h6 className="text-primary fw-bold mb-2">Course Details</h6>
                  <p className="mb-1"><strong>Type:</strong> {selectedCourse.courseType}</p>
                  <p className="mb-1"><strong>Duration:</strong> {selectedCourse.courseDuration}</p>
                  <p className="mb-1"><strong>Fees:</strong> ₹{selectedCourse.courseFees}</p>
                  <p className="mb-0"><strong>Installment:</strong> {selectedCourse.installment}</p>
                </div>
              </div>
            )}
